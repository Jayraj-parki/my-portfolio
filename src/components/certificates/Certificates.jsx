...
export default function Certificates() {
  return (
    <div id="certificate" className={style.certificate + " container-fluid p-0  py-4 "}>
      ...
      <div
        className={
          style.wrapper +
          " row col-lg-11 col-xl-10  mx-auto p-0 py-4 d-flex justify-content-between flex-column "
        }
      >
